...
def convert_pptx_to_pdf(input_file, output_file):
    if not POWERPOINT_INSTALLED:
        print("PowerPoint automation not available.")
        return False
    try:
        ...
        presentation.Close()
        powerpoint.Quit()
        return os.path.exists(output_file_abs)
...
def convert_file(input_file, output_file):
    ...
    if output_ext == '.pdf':
        if input_ext == '.txt':
            ...
            print(f"Unsupported input for PDF conversion: {input_ext}")
            return False

    # Handle conversions from PDF
    elif input_ext == '.pdf':
        if output_ext == '.docx':
            ...
            print(f"Unsupported output for PDF input: {output_ext}")
            return False
    ...
    # TXT conversions
        ...
        if output_ext == '.docx':
            ...
            print(f"Unsupported output for TXT input: {output_ext}")
            return False
    ...
    # DOCX conversions
        ...
        if output_ext == '.txt':
            ...
            print(f"Unsupported output for DOCX input: {output_ext}")
            return False
